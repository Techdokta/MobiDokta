...
const PRODUCTS = [
  ...
  { id:'ds-001', cat:'diy', name:'DIY Screen — iPhone 8 / SE',           sub:'Part only · fit yourself & save',        price:449,  priceS:380,  icon:'monitor', color:'linear-gradient(135deg,#2a0000,#5a1010)', badge:'' },
  { id:'ds-002', cat:'diy', name:'DIY Screen — iPhone X',                sub:'Part only · fit yourself & save',        price:699,  priceS:590,  icon:'monitor', color:'linear-gradient(135deg,#2a0000,#5a1010)', badge:'' },
  ...
  { id:'ds-004', cat:'diy', name:'DIY Screen — iPhone XS',               sub:'Part only · fit yourself & save',        price:749,  priceS:630,  icon:'monitor', color:'linear-gradient(135deg,#2a0000,#5a1010)', badge:'' },
  { id:'ds-005', cat:'diy', name:'DIY Screen — iPhone XS Max',           sub:'Part only · fit yourself & save',        price:849,  priceS:720,  icon:'monitor', color:'linear-gradient(135deg,#2a0000,#5a1010)', badge:'' },
  ...
  { id:'ds-012', cat:'diy', name:'DIY Screen — iPhone 13 Pro',           sub:'Part only · fit yourself & save',        price:1299, priceS:1100, icon:'monitor', color:'linear-gradient(135deg,#2a0000,#5a1010)', badge:'' },
  { id:'ds-013', cat:'diy', name:'DIY Screen — iPhone 13 Pro Max',       sub:'Part only · fit yourself & save',        price:1499, priceS:1270, icon:'monitor', color:'linear-gradient(135deg,#2a0000,#5a1010)', badge:'' },
  { id:'ds-014', cat:'diy', name:'DIY Screen — iPhone 14 / 14 Plus',     sub:'Part only · fit yourself & save',        price:1099, priceS:930,  icon:'monitor', color:'linear-gradient(135deg,#2a0000,#5a1010)', badge:'' },
  ...
  { id:'ds-016', cat:'diy', name:'DIY Screen — iPhone 14 Pro Max',       sub:'Part only · fit yourself & save',        price:1899, priceS:1610, icon:'monitor', color:'linear-gradient(135deg,#2a0000,#5a1010)', badge:'' },
  { id:'ds-017', cat:'diy', name:'DIY Screen — iPhone 15 / 15 Plus',     sub:'Part only · fit yourself & save',        price:1399, priceS:1180, icon:'monitor', color:'linear-gradient(135deg,#2a0000,#5a1010)', badge:'' },
  { id:'ds-018', cat:'diy', name:'DIY Screen — iPhone 15 Pro',           sub:'Part only · fit yourself & save',        price:1899, priceS:1610, icon:'monitor', color:'linear-gradient(135deg,#2a0000,#5a1010)', badge:'' },
  ...
  { id:'ds-020', cat:'diy', name:'DIY Screen — iPhone 16 / 16 Plus',     sub:'Part only · fit yourself & save',        price:1599, priceS:1350, icon:'monitor', color:'linear-gradient(135deg,#2a0000,#5a1010)', badge:'' },
